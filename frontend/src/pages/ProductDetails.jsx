      ...
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-md p-6 grid md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="bg-black text-white py-3 rounded cursor-pointer disabled:opacity-50"
          >
      ...
      <div className="max-w-6xl mx-auto mt-10 bg-white p-6 rounded-2xl shadow">
        ...
        <div className="flex justify-between items-center mb-5">
          ...
          <button
            ...
            className="border px-4 py-2 rounded-full hover:bg-gray-100 cursor-pointer disabled:opacity-50"
          >
